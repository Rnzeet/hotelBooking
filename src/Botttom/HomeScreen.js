...
//   // const navigateToTapeChartScreen = () => {
//   //   // Reset the navigation state to CheckInList screen
//   //   navigation.dispatch(
//   //     CommonActions.reset({
//   //       index: 1,
//   //       routes: [{ name: 'Home' }, { name: 'TapeChart' }],
//   //     })
//   //   );
//   // };
...
//   // };
//   const navigateToCheckOutScreen = () => {
//     // Navigate to the 'CheckOutNav' screen directly
//     navigation.navigate("Check Out List");
//   };
//   const navigateToCheckInScreen = () => {
//     // Navigate to the 'CheckOutNav' screen directly
//     navigation.navigate('Check In List');
//   };  const navigateToTapeChartScreen = () => {
//     // Navigate to the 'CheckOutNav' screen directly
//     navigation.navigate("TapeChart");
//   };
//   return (
//     <ScrollView
...
//         </View>
//       </View>
//       <TouchableOpacity style={styles.card} onPress={navigateToTapeChartScreen}>
//         <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
//           <FontAwesome5 name='key' size={45} color="#0186C1" />
//           <Text style={styles.count}>{checkIns}</Text>
//         </View>
//         <Text style={styles.txt}>TAPECHART</Text>
//       </TouchableOpacity>
